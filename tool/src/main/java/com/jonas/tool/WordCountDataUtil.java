 ...
 * 产生词频统计模拟数据
 */
public class WordCountDataUtil {

    public static final List<String> WORDS = Arrays.asList("Spark", "Hadoop", "HBase", "Storm", "Flink", "Hive");
    ...
    private static String generateData() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            String line = StringUtils.join(WORDS.toArray(), "\t", 0, endIndex);
